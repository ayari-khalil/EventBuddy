package dev.flonixa.com.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("dev.flonixa.com.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("dev.flonixa.com.security.DomainUserDetailsService", "createSpringSecurityUser");
